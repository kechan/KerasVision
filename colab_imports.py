...
call(["gunzip", "train_224_224.hdf5.gz"])
call(["mv", "train_224_224.hdf5", "/content/data/224x224_cropped_merged_heads_hdf5"])

call(["gunzip", "validation_224_224.hdf5.gz"])
call(["mv", "validation_224_224.hdf5", "/content/data/224x224_cropped_merged_heads_hdf5"])

call(["gunzip", "test_224_224.hdf5.gz"])
call(["mv", "test_224_224.hdf5", "/content/data/224x224_cropped_merged_heads_hdf5"])
